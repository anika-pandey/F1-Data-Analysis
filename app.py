...
race = st.sidebar.selectbox("Select a race", race_names)
...
driver = st.sidebar.selectbox("Select a driver", driver_list)
...
st.subheader("Pit Stop Time Loss")
...
st.subheader("Gap to Leader Over Time")
